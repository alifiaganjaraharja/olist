...
## Executive Summary
This project analyzes customer behavior, payment preferences, geographic distribution, and logistics performance for Olist, Brazil's largest e-commerce department store marketplace.

By analyzing historical order data using SQLite and Looker, this study identifies key revenue drivers and operational strengths—such as a strong 91.9% on-time delivery rate—while highlighting strategic expansion opportunities in top revenue-generating regions like São Paulo (SP) and Rio de Janeiro (RJ).
